...
NODE_SERVICES=(sandbox-backend fiks-simulator ai-gateway tools-api process-agent matrikkel-mock digdir-mock pasientjournal-mock politiattest-mock demo-gui process-builder lommebok politiattest-flyt)
SERVICE_PORTS=(8080 8081 8082 8083 8084 8085 8086 8087 8088 3000 3001 3002 3003)
OLLAMA_PORT=11434
