...
NODE_SERVICES=(sandbox-backend fiks-simulator ai-gateway tools-api process-agent matrikkel-mock digdir-mock pasientjournal-mock politiattest-mock hjemmelsok demo-gui process-builder lommebok politiattest-flyt)
SERVICE_PORTS=(8080 8081 8082 8083 8084 8085 8086 8087 8088 8089 3000 3001 3002 3003)
OLLAMA_PORT=11434
...
printf '   🪪 Digital lommebok:    http://localhost:3002\n'
printf '   👮 Politiattest-flyt:   http://localhost:3003\n'
