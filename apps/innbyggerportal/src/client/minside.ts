...
/** Navnet ID-porten viser innbyggeren. Se LoginValg i felles.ts. */
...
function tegnProfilknapper(minside: Minside): HTMLElement {
  ...
  const samtykker = attributter(lag("button", "ds-button", "Samtykker og varsler"), {
    // gaaTil("samtykker") klikker denne for å åpne panelet under.
    id: "knapp-samtykker",
    type: "button",
    "aria-expanded": "false",
...
function tegnTjeneste(tjeneste: Tjeneste): HTMLElement {
  ...
  // gaaTil("postkasse") slår opp raden på denne id-en.
