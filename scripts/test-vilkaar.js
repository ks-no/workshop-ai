...
function countPlasser(ordning, plasser) {
...
let kastet = false;
try {
  evaluateVilkaar("FINNES_IKKE", { tilstand: medHusstand(tilstandMed()), personId: "p-voksen", ordning: ORDNING_INNTEKT, satser, grunnlag: 1, felles: {}, forbehold: "" });
} catch (error) {
